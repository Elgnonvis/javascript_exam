...
$(document).ready(function () {
    ...
    function score_indicate() {
      ...
      let saveSum = ($("#sum_indicate").text(sum));
      $("#average_indicate").text(saveSum.text()/number);
    ...
    function judgement() {
      ...
      $('#declaration').find("label").hide(); // hide le label qui a été ajouté à l'aide de append pour de nouvel clic sur le bouton
      $('#declaration').append(`<label id="alert-indicate" class="alert alert-info">Ton niveau est ${achievement}. Tu as ${pass_or_failure}.</label>`);
    };
    ...
    $('#btn-declaration').click(function () {
      judgement();
     // $('#declaration').text("");//envoyer une chaine vide
